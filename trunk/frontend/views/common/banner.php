...
<section id="dg-container" class="dg-container">
    <div class="dg-wrapper">
        ...
        <a data-toggle="modal" class="openDetailDiaLog" href="#largeModal" data-id="<?=$slideimage['ID']?>"><img src="<?=$slideimage['URL']?>" alt="imga of product" width="270px" height="360px"/><div></div></a>
        <?php endforeach;?>
    </div>
</section>
