...
/*
 * File chua thong tin define ngon ngu tieng viet
 * 
 */
...
define('HELLO_USER', 'Xin chào');
define('PROFILE_USER', 'Thông tin cá nhân');
define('LOGOUT', 'Đăng xuất');
//paging
define('PREVIOUS_PAGE', 'Trang trước');
define('NEXT_PAGE', 'Trang tiếp');
//login form
define('TITLE_LOGIN', 'Đăng Nhập');
define('USERNAME_PLACEHOLDER', 'Nhập tài khoản của bạn');
define('PASSWORD_PLACEHOLDER', 'Nhập mật khẩu của bạn');
...
//register
//===============================================================================
define('REGISTER_MEMBER', 'ĐĂNG KÝ THÀNH VIÊN');

define('REGISTER_INFOMATION_BASE', 'Thông Tin Cơ Bản');
define('REGISTER_INFOMATION_CONTACT', 'Thông Tin Liên Hệ');
define('REGISTER_INFOMATION_ORTHER', 'Thông Tin Khác');
...
//profile
//===============================================================================
define('PROFILE_HELLO', 'Xin chào: ');
define('PROFILE_MY', 'THÔNG TIN CÁ NHÂN');

define('PROFILE_INFOMATION_BASE', 'Thông Tin Cơ Bản');
define('PROFILE_INFOMATION_CONTACT', 'Thông Tin Liên Hệ');
define('PROFILE_INFOMATION_ORTHER', 'Thông Tin Khác');

define('PROFILE_USERNAME', 'Tên Đăng Nhập');
define('PROFILE_PASSWORD', 'Mật Khẩu');
define('PROFILE_PASSWORD_DELAY', 'Nhập lại mật khẩu');
define('PROFILE_PASSWORD_DELAY_PLEASE', 'Hãy nhập lại mật khẩu');
define('PROFILE_EMAIL', 'Email');

define('PROFILE_ADDRESS', 'Địa Chỉ: ');
define('PROFILE_DISTRICT', 'Quận: ');
define('PROFILE_PROVINCE', 'Thành Phố: ');
define('PROFILE_STREET', 'Đường: ');

define('PROFILE_PHONENUMBER', 'Số Điện Thoại: ');
define('PROFILE_NAME', 'Tên: ');
define('PROFILE_DATE', 'Ngày Sinh: ');
define('PROFILE_POINT', 'Bậc: ');
define('PROFILE_EDIT', 'Chỉnh sửa');
define('PROFILE_CLOSED', 'Đóng');
...
define('USER_CONTACT_US', 'LIÊN HỆ CHÚNG TÔI');
define('USER_CONTACT_NAME', 'Tên');
define('USER_CONTACT_ENTER_NAME', 'Nhập tên');
define('USER_CONTACT_EMAIL', 'Email');
define('USER_CONTACT_ENTER_EMAIL', 'Nhập Email');
define('USER_CONTACT_CONTENT_CONTACT', 'Nội dung liên hệ');
define('USER_CONTACT_INSERT_CAPTCHA', 'Nhập captcha');
define('USER_CONTACT_PLEASE_INSERT_CAPTCHA', 'Hãy nhập captcha');
define('USER_CONTACT_SENT', 'Gửi');
define('USER_CONTACT_RESET', 'Xóa hết');
define('USER_CONTACT_CLOSED', 'Đóng');
...
define('PROMOTIONS_INFOR_PROGRAM', 'Thông tin chương trình khuyến mãi');
define('PROMOTIONS_NAME_PROGRAM', 'Tên chương trình: ');
define('PROMOTIONS_CONTENT_PROGRAM', 'Nội dung chương trình: ');
define('PROMOTIONS_TIME_APPLY', 'Thời gian áp dụng: ');
define('PROMOTIONS_TIME_FINISH', 'Thời gian kết thúc: ');
define('PROMOTIONS_INFOR_PRODUCT', 'Thông tin sản phẩm khuyến mãi');
define('PROMOTIONS_STT', 'STT');
define('PROMOTIONS_NAME_PRODUCT', 'Tên sản phẩm');
define('PROMOTIONS_IMAGE_PRODUCT', 'Ảnh');
define('PROMOTIONS_COST_VN_PROGRAM', 'Giá VND');
define('PROMOTIONS_COST_USD_PROGRAM', 'Giá USD');
define('PROMOTIONS_PRICES_ALSO', 'Tỉ lệ giảm giá');
define('PROMOTIONS_SALE_OFF_VN', 'Giá VND còn');
define('PROMOTIONS_SALE_OFF_USD', 'Giá USD còn');
define('PROMOTIONS_EMPTY', 'Chưa có chương trình khuyến mãi tại thời điểm hiện tại !');
...
//===============================================================================
define('CART_STT', 'STT');
define('CART_IMAGE', 'Ảnh');
define('CART_PRODUCT','Sản phẩm');
...
//===============================================================================
// bắt lỗi form register
//===============================================================================
define('REGISTER_ACCOUNT_INVALID', 'Tài khoản không hợp lệ');
define('REGISTER_PASSWORD_NOT_EMPTY', 'Mật khẩu không được rỗng!');
define('REGISTER_CONFIRM_PASSWORD', 'Nhập xác nhận lại mật khẩu!');
define('REGISTER_CONFIRM_PASSWORD_AGAIN', 'Mật khẩu và xác nhận mật khẩu không khớp!');
