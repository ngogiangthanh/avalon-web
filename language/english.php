...
//user
define('CART', 'Cart');
define('HELLO_USER', 'Hello');
define('PROFILE_USER', 'My profile');
define('LOGOUT', 'Logout');
//paging
define('PREVIOUS_PAGE', 'Previous');
define('NEXT_PAGE', 'Next');
//login form
define('TITLE_LOGIN', 'Login');
define('USERNAME_PLACEHOLDER', 'Enter your username');
define('PASSWORD_PLACEHOLDER', 'Enter your password');
define('LOGIN_BUTTON', 'Submit');
define('REGISTER_LINK', 'Register account');
//alert login 
...
//profile
//===============================================================================
define('PROFILE_HELLO', 'Hello: ');
define('PROFILE_MY', 'MY PROFILE');

define('PROFILE_INFOMATION_BASE', 'Base information');
...
define('USER_CONTACT_US', 'CONTACT US');
define('USER_CONTACT_NAME', 'Name');
define('USER_CONTACT_ENTER_NAME', 'Enter name');
define('USER_CONTACT_EMAIL', 'Email');
define('USER_CONTACT_ENTER_EMAIL', 'Enter Email');
define('USER_CONTACT_CONTENT_CONTACT', 'Content contact');
define('USER_CONTACT_INSERT_CAPTCHA', 'Insert captcha');
define('USER_CONTACT_PLEASE_INSERT_CAPTCHA', 'Please insert captcha');
define('USER_CONTACT_SENT', 'Send');
define('USER_CONTACT_RESET', 'Reset');
define('USER_CONTACT_CLOSED', 'Closed');
...
define('PROMOTIONS_IMAGE_PRODUCT', 'Image');
define('PROMOTIONS_COST_VN_PROGRAM', 'Cost VND');
define('PROMOTIONS_COST_USD_PROGRAM', 'Cost USD');
define('PROMOTIONS_PRICES_ALSO', 'Discount');
define('PROMOTIONS_SALE_OFF_VN', 'Price after discount in VND');
define('PROMOTIONS_SALE_OFF_USD', 'Price after discount in USD');
define('PROMOTIONS_EMPTY', 'Sorry, we don\'t have any promotion at this time, please come back later!');
...
define('CART_CAPTA_INCORRECT', 'Password incorrect !!');
define('CART_EMAIL_INCORRECT', 'Email incorrect !!');
define('CART_ADDESS_INCORRECT', 'Address incorrect !!');
define('CART_STRESS_INCORRECT', 'Stress incorrect !!');
define('CART_DISTRICT_INCORRECT', ' District incorrect');
define('CART_PROVINCE_INCORRECT', ' Province incorrect');
define('CART_NAME_INCORRECT', 'Name incorrect ');
define('CART_DATE_CORRECT', 'Date correct!!');
define('CART_PHONENUMBER_CORRECT', ' Phone number correct!!');
define('CART_CHANGE_SUCCESS', 'Change information success!!');
...
define('CONTACT_EMPTY', 'Contact code not empty !');
define('CONTACT_CAPTA_INCORRECT', 'Captcha code incorrect !!');
define('CONTACT_REVIEW', 'Sending feedback success. Thank you, We will examine and reply soon !!');


//===============================================================================
// bắt lỗi form register
//===============================================================================
define('REGISTER_ACCOUNT_INVALID', 'Invalid account');
define('REGISTER_PASSWORD_NOT_EMPTY', "Password not empty!");
define('REGISTER_CONFIRM_PASSWORD', 'Retype password!');
define('REGISTER_CONFIRM_PASSWORD_AGAIN', 'Password do not match!');
define('REGISTER_SUCCESS', 'Register successful!');
define('REGISTER_USER_TO_BE', 'User name is already used!');
define('REGISTER_EMAIL_TO_BE', 'Email is already used!');
define('REGISTER_UNSUCCESS', 'Register failed');
define('REGISTER_NAME_CORRECT', 'Name correct! ');
